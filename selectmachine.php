        ...
        <div id="splash">
            ...
            <form id="frmPurchase" name="frmPurchase" action="redirect.php" method="POST">
                <select id="location" name="location">
                    <option value="jeffprestes/candies/paulista" selected="selected">Brazil, Sao Paulo, Alameda Santos</option>
                    <option value="jeffprestes/candies/world">Brazil, Sao Paulo, Demonstration</option>
                </select>
                <br /><br />
